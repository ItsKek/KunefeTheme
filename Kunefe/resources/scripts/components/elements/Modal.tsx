...
const ModalContainer = styled.div<{ alignTop?: boolean }>`
    ...
    & > .close-icon {
        ${tw`hidden right-0 p-2 text-white cursor-pointer opacity-50 transition-all duration-150 ease-linear hover:opacity-100`};
        display: none;
        ...
        >
            ...
            >
                <ModalContainer alignTop={top}>
                    ...
                    <div css={tw`bg-neutral-905 p-3 sm:p-4 md:p-6 rounded shadow-md overflow-y-scroll transition-all duration-150`}>
                        {children}
                    </div>
                </ModalContainer>
            </ModalMask>

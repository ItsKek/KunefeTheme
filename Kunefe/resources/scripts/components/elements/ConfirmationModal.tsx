    ...
    return (
        <>
            ...
            <div css={tw`flex flex-wrap items-center justify-end mt-8`}>
                <Button color={'purple'} onClick={() => dismiss()} css={tw`w-full sm:w-auto border-transparent`}>
                    Cancel
                </Button>
                <Button color={'purple'} css={tw`w-full sm:w-auto mt-4 sm:mt-0 sm:ml-4`} onClick={() => onConfirmed()}>
                    {buttonText}
                </Button>
            </div>
        </>

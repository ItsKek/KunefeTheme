    ...
    return (
        <Modal {...props} showSpinnerOverlay={isSubmitting}>
            <Form>
                ...
                <h2 css={tw`text-2xl text-white mb-6`}>Create server backup</h2>
                <Field
                    name={'name'}
                    label={'Backup name'}
                ...
                <div css={tw`flex justify-end mt-6`}>
                    <Button color={'purple'} type={'submit'} disabled={isSubmitting}>
                        Start backup
                    </Button>
                </div>
            </Form>
...
export default () => {
    ...
    return (
        <>
            ...
            <Button color={'purple'} size={'xsmall'} onClick={() => setVisible(true)}>
                Create backup
            </Button>
        </>
    );
